...
def build_multi_relation_graph() -> tuple[ComputationGraph, dict]:
    ...
    final_price = InputSpec("property", "Product", "final_price")
    ...
    buyer_pay = OutputSpec("property", "Buyer", "buyer_pay")
    ...
    calc_buyer_pay = ComputationNode(
        id="calc_buyer_pay",
        name="calculate_buyer_pay",
        level=ComputationLevel.PROPERTY,
        inputs=(final_price,),
        outputs=(buyer_pay,),
        code="final_price",
    ...
    relationships = [
        ...
        # calc_buyer_pay dependencies
        ComputationRelationship("rel_final_price_to_calc_buyer_pay", PRODUCT_NODE_ID, "calc_buyer_pay",
            "final_price_depends", ComputationRelationType.DEPENDS_ON, "property", datasource=final_price),
        ComputationRelationship("rel_calc_buyer_pay_to_buyer_pay", "calc_buyer_pay", PRODUCT_NODE_ID,
            "buyer_pay_result", ComputationRelationType.OUTPUT_TO, "property", data_output=buyer_pay),
    ]

    # Build graph
    graph = ComputationGraph(id="multi_relation_computation_graph")
    for node in [calc_total, calc_discount, calc_tax, calc_buyer_pay]:
